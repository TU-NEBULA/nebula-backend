...
public enum ErrorStatus implements BaseErrorCode {
	...
	_REFRESH_TOKEN_INVALID(HttpStatus.UNAUTHORIZED, "USER4010", "Refresh token이 유효하지 않습니다."),
	_REFRESH_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "USER4011", "Refresh token이 만료되었습니다."),;
